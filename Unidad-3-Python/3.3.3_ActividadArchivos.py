...
# Segmentación de datos por tamaño de contribución
pequeno = [registro for registro in datoscsv if registro[2] <= 100000000]
mediano = [registro for registro in datoscsv if 100000001 <= registro[2] <= 200000000]
gran = [registro for registro in datoscsv if registro[2] >= 200000000]
